...
**Related Features:**
- [Object Search](SqlLens_Concise_Guide.md#use-object-search) - Search within current database
- [Dependency Analyzer](SqlLens_User_Guide_Full.md#step-8-review-analysis-results) - Analyze search results
- [Multi-Tab Workflow](SqlLens_Concise_Guide.md#multi-tab-workflow) - Work with multiple objects
...
**Documentation:**
- [Quick Start Guide](SqlLens_Quick_Start_Guide.md) - Getting started
- [Concise Guide](SqlLens_Concise_Guide.md) - Essential features
...
**For more help:** See [Full User Guide](SqlLens_User_Guide_Full.md)
